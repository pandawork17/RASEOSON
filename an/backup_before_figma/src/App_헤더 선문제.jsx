...
function PaymentPage({ orderData, paymentData, onChange, onComplete }) {
  ...
  // 결제수단 아이콘
  // 파일 위치: public/images/icons/
  // 파일명: payment_card.svg / payment_kakao.svg / payment_naver.svg / payment_toss.svg / payment_bank.svg
  const methods = [
          ...
          <section className="mypage-content refund-content">
            ...
            <div className="refund-guide">
              ...
              <ul>
                ...
                <li>보다 자세한 내용은 고객센터 또는 자주 묻는 질문을 이용해주세요.</li>
              </ul>
            </div>
          </section>
        </div>
